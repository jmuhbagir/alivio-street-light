...
public class PublishMQTT extends AbstractMQTTProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        // get the MQTT username for thingsboard
        if(context.getProperty(PROP_USERNAME).isSet()) {
          String username = context.getProperty(PROP_USERNAME).evaluateAttributeExpressions(flowfile).getValue();
          logger.info("Set mqtt username "+username);
